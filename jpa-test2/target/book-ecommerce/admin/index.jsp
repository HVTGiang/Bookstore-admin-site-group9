                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <c:forEach items="${orderList}" var="o">
                                        <tr>
                                            <th scope="row"><a
                                                    href="/admin/order?action=edit&orderID=${o.id}">${o.id}</a></th>
                                            <td><a href="/admin/order?action=edit&orderID=${o.id}">${o.contactName}</a>
                                            </td>
                                            <td>${o.createTime}</td>
                                            <td>${o.phone}</td>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <c:forEach items="${book5List}" var="b">
                                        <tr>
                                            <th scope="row"><a
                                                    href="/admin/book?action=edit&productID=${b.id}">${b.id}</a></th>
                                            <td><a href="/admin/book?action=edit&productID=${b.id}">${b.name}</a></td>
                        ...
                        <c:if test="${not empty bestSellerBook}">
                            ...
                            <h5 class="card-text margin-top-10"
                                style="margin-bottom: 20px; text-align: center; margin-top: 20px"><b><a
                                    href="/admin/book?action=edit&productID=${bestSellerBook.id}">${bestSellerBook.name}</a></b>
                            </h5>
                        </c:if>
                ...
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <c:if test="${not empty bestCustomerByPrice}">
                            ...
                            <h5 class="card-text margin-top-10"
                                style="margin-bottom: 20px; text-align: center; margin-top: 20px"><b><a
                                    href="/admin/customer?action=edit&customerID=${bestCustomerByPrice.id}">${bestCustomerByPrice.name}</a></b>
                            </h5>
                        </c:if>
