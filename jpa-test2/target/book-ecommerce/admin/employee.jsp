                                    ...
                                    <c:forEach items="${employeeList}" var="e">
                                        <tr>
                                            ...
                                            <td class="action-column">
                                                <a href="/admin/employee?action=edit&employeeID=${e.id}"
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <input class="btn btn-danger margin-top-10 full-column-width" type="submit"
                                                           value="Delete"
                                                           onclick="if (confirm('Bạn có chắc chắn muốn xóa nhân viên này?')) { form.action='/admin/employee'; } else { return false; }"/>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
