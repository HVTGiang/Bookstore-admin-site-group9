                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered margin-top-30" id="borderedTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link ${category.id==0?"active":""}" id="home-tab"
                               ...
                               aria-selected="true" href="/admin/book?cID=0">Tất cả
                            </a>
                        </li>
                        <c:forEach items="${categoryList}" var="c">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link ${category.id==c.id?"active":""}" id="profile-tab"
                                   ...
                                   aria-selected="false" tabindex="-1" href="/admin/book?cID=${c.id}">${c.name}
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
                                    ...
                                    <c:forEach items="${bookList}" var="b">
                                        <tr>
                                            ...
                                            <td class="action-column">
                                                <a href="/admin/book?action=edit&productID=${b.id}"
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <input class="btn btn-danger margin-top-10" type="submit"
                                                           value="Xóa"
                                                           onclick="if (confirm('Bạn có chắc chắn muốn xóa món hàng này?')) { form.action='/admin/book'; } else { return false; }"/>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
