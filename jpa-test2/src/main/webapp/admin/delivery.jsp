                                    ...
                                    <c:forEach items="${deliveryList}" var="d">
                                        <tr>
                                            ...
                                            <td class="action-column">
                                                <a href="/admin/delivery?action=edit&deliveryID=${d.id}"
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <input class="btn btn-danger margin-top-10 full-column-width"
                                                           type="submit"
                                                           value="Xóa"
                                                           onclick="if (confirm('Bạn có chắc chắn muốn xóa phương thức này này (không thể khôi phục)?')) { form.action='/admin/delivery'; } else { return false; }"/>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
