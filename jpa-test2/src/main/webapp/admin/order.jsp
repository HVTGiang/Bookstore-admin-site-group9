                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered margin-top-30" id="borderedTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link ${status.id==0?"active":""}" id="home-tab"
                               ...
                               aria-selected="true" href="/admin/order?sID=0">Tất cả
                            </a>
                        </li>
                        <c:forEach items="${statusList}" var="s">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link ${status.id==s.id?"active":""}" id="profile-tab"
                                   ...
                                   aria-selected="false" tabindex="-1" href="/admin/order?sID=${s.id}">${s.name}
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
                                                ...
                                                <c:if test="${o.status==1}">
                                                    <form action="" method="post">
                                                        ...
                                                        <input class="btn btn-outline-danger margin-top-10 full-column-width"
                                                               type="submit"
                                                               value="Hủy"
                                                               onclick="if (confirm('Bạn có chắc chắn muốn hủy đơn này?')) { form.action='/admin/order'; } else { return false; }"/>
                                                    </form>
                                                </c:if>
                                                <a href="/admin/order?action=edit&orderID=${o.id}"
