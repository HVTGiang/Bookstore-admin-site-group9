        ...
        <div class="row">
            ...
            <div class="col-lg-8 recent-sales">
                <div class="row">
                    ...
                    <!-- Add button -->
                    <form action="/admin/paymethod" method="get">
                                    ...
                                    <c:forEach items="${paymethodList}" var="p">
                                        <tr>
                                            ...
                                            <td class="action-column">
                                                <a href="/admin/paymethod?action=edit&paymethodID=${p.id}"
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <input class="btn btn-danger margin-top-10 full-column-width"
                                                           type="submit"
                                                           value="Xóa"
                                                           onclick="if (confirm('Bạn có chắc chắn muốn xóa phương thức này này (Không thể khôi phục)?')) { form.action='/admin/paymethod'; } else { return false; }"/>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
